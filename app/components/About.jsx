...
export default function About () {
    ...
    return (
        <section id="about" className="min-h-[60vh] w-full flex justify-start items-center px-5 sm:px-10  lg:p-10" style={{background:bgColor, color:txtColor}} > 
            <div className="flex flex-col lg:px-10">
                <div  className={`text-4xl md:text-5xl font-semibold pb-10  space-y-2 w-fit` }>
                    <h2 className="pb-3 inline-block uppercase">Something about me</h2>
                    
                </div>
                <div className={`text-sm sm:text-lg block md:text-2xl w-full md:w-4/6 leading-[1.4]  z-10` }>
