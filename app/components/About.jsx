...
export default function About () {
    ...
    return (
        <section id="about" className="min-h-[80vh] w-full flex justify-start items-center px-5 sm:px-10  lg:p-10 " > 
            <div className="flex flex-col lg:px-10">
                ...
                <div className={`text-xl block md:text-2xl w-full md:w-4/6 leading-[1.4] text-[#d7d7d7] z-10` }>
