...
export default function Navbar({changeColor}){
    ...
    return (
        ...
        className={` fixed top-0 left-0 w-full z-50 py-4 px-2 sm:py-5 md:py-6 flex justify-center items-center backdrop-blur`} style={{color:txtColor, background: bgColor+"90"}}>           
